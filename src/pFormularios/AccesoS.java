...
public class AccesoS extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("LOGIN SUPERVISOR");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(310, 70, 660, 110);
        ...
        setSize(new java.awt.Dimension(1154, 687));
    ...
    private void bnLoginMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_bnLoginMouseClicked
        ...
        if(txtUsuario.getText().equals(Usuario)  && Pass.equals(Contraseña)){
            ...
            frVentasDiarias vd = new frVentasDiarias();
            vd.setVisible(true);
            dispose();
        }
        else{
